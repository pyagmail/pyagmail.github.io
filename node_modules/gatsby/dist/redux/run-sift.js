...
const {
  ...
  addResolvedNodes,
  getNode: siftGetNode
} = require(`./nodes`); // More of a testing mechanic, to verify whether last runSift call used Sift
...
const applyFilters = (filterFields, firstOnly, nodeTypeNames, filtersCache, resolvedFields, stats) => {
  ...
  = filterWithoutSift(filters, nodeTypeNames, filtersCache);
  lastFilterUsedSift = false;
  ...
  const siftResult
  /*: Array<IGatsbyNode> | null */
  = filterWithSift(filters, firstOnly, nodeTypeNames, resolvedFields);
